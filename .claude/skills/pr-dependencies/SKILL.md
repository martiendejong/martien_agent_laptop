...
```markdown
## <timestamp> - Hazina PR #35 → client-manager PR #93
...
```
🚨 MERGE ORDER VIOLATION PREVENTED 🚨
...
### 2026-01-12 20:00 - Hazina #35 → client-manager #93
- **Hazina:** #35 (OPEN) - Add new LLM method
- **client-manager:** #93 (BLOCKED) - Feature using new method
- **Status:** Waiting for Hazina #35 merge
- **Agent:** agent-001

### 2026-01-12 21:00 - Hazina #36 → client-manager #94
- **Hazina:** #36 (MERGED ✅) - Fix token counting
...
### 2026-01-12 - Hazina #33 → client-manager #91
- **Hazina:** #33 (MERGED ✅) - Config templates
- **client-manager:** #91 (MERGED ✅) - Use config templates
...
### Scenario 1: Framework Feature → Application Usage

```
1. Hazina PR #XX - Add new feature to framework
2. client-manager PR #YY - Use new framework feature

Merge order: Hazina #XX → client-manager #YY
```

### Scenario 2: Framework Bug Fix → Application Fix
...
⚠️ CRITICAL: Must merge together, coordinate deployment
Merge order: Hazina #XX → Deploy → client-manager #YY → Deploy
```
