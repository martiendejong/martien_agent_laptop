# Belplan Arjan Stroeve - 50 Expert Council Strategy
...
Dit gesprek is cruciaal en multi-dimensionaal. Het raakt aan:
- **Zakelijke onderhandeling** (openstaande facturen)
- **Relationele dynamiek** (mogelijke spanning na Cassandra)
- **Strategische kansen** (Brand2Boost toekomst)
- **Psychologische aspecten** (jouw eigen emoties, Arjan's perspectief)
- **Communicatie** (hoe breng je dit?)
- **Juridische bescherming** (voor het geval dat)

Elk van deze 50 experts brengt unieke inzichten die samen een compleet beeld vormen.

---

## EXPERT OVERZICHT

### CATEGORIE A: Onderhandeling & Beïnvloeding (Experts 1-10)

| # | Expert | Periode/Werk | Rol in Dit Plan |
|---|--------|--------------|-----------------|
| 1 | **Robert Cialdini** | Psycholoog - "Influence: The Psychology of Persuasion" | **LEAD EXPERT ONDERHANDELING** - 6 principes van beïnvloeding toepassen |
| 2 | **Chris Voss** | Ex-FBI hostage negotiator - "Never Split the Difference" | Tactische empathie en onderhandelingstechnieken |
| 3 | **William Ury** | Harvard - "Getting to Yes", "Getting Past No" | Win-win onderhandeling, BATNA strategie |
| 4 | **Sun Tzu** | Chinees strateeg - "The Art of War" | Strategische positionering zonder conflict |
| 5 | **Dale Carnegie** | "How to Win Friends and Influence People" | Relatiebouw en menselijke connectie |
| 6 | **Roger Fisher** | Harvard Negotiation Project | Principled negotiation methode |
| 7 | **Herb Cohen** | "You Can Negotiate Anything" | Power dynamics en timing |
| 8 | **Jim Camp** | "Start With No" | De kracht van nee, controle behouden |
| 9 | **Deepak Malhotra** | Harvard - "Negotiating the Impossible" | Onmogelijke deals mogelijk maken |
| 10 | **Stuart Diamond** | Wharton - "Getting More" | Emotie-gebaseerde onderhandeling |

---

### Waarom Elk Expert Onmisbaar Is (A1-A10):
...
- **Waarom onmisbaar:** Als ex-FBI onderhandelaar heeft hij geleerd hoe je mensen in gespannen situaties naar je toe trekt. Het gesprek met Arjan kan gespannen zijn.
- **Specifieke bijdrage:** "Labeling" techniek - benoem Arjan's mogelijke emoties voordat hij ze uit. "Het klinkt alsof het project destijds niet liep zoals we beiden hoopten..."

**3. William Ury**
*"The biggest mistake is to react. When you react, you lose."*
- **Waarom onmisbaar:** BATNA (Best Alternative To Negotiated Agreement) - je moet weten wat je alternatieven zijn VOORDAT je belt. Anders onderhandel je vanuit zwakte.
- **Specifieke bijdrage:** Plan B helder hebben. Als Arjan niet betaalt, wat dan? Dit geeft innerlijke rust.
...
### CATEGORIE B: Psychologie & Emotionele Intelligentie (Experts 11-20)

| # | Expert | Periode/Werk | Rol in Dit Plan |
|---|--------|--------------|-----------------|
| 11 | **Carl Rogers** | Humanistische psychologie - "On Becoming a Person" | **LEAD EXPERT EMPATHIE** - Onvoorwaardelijke positieve aandacht |
| 12 | **Daniel Goleman** | "Emotional Intelligence" | EQ toepassen in het gesprek |
| 13 | **Brené Brown** | "Daring Greatly", kwetsbaarheid | Kracht van kwetsbaarheid tonen |
| 14 | **Viktor Frankl** | "Man's Search for Meaning" | Betekenis vinden in moeilijke situatie |
| 15 | **Albert Ellis** | REBT - Rationeel-Emotieve Therapie | Irrationele gedachten herkennen |
| 16 | **Aaron Beck** | Cognitieve therapie | Cognitieve vertekeningen corrigeren |
| 17 | **Carl Jung** | Analytische psychologie | Schaduwwerk - eigen projecties herkennen |
| 18 | **Abraham Maslow** | Behoeftehiërarchie | Arjan's en jouw behoeften begrijpen |
| 19 | **Marshall Rosenberg** | "Nonviolent Communication" | Geweldloze communicatie technieken |
| 20 | **Irvin Yalom** | Existentiële psychotherapie | Dieperliggende angsten adresseren |

---

### Waarom Elk Expert Onmisbaar Is (B11-B20):
...
### CATEGORIE C: Zakelijke Strategie & Financiën (Experts 21-30)
...
### Waarom Elk Expert Onmisbaar Is (C21-C30):
...
### CATEGORIE D: Communicatie & Presentatie (Experts 31-38)
...
### Waarom Elk Expert Onmisbaar Is (D31-D38):
...
### CATEGORIE E: Conflictresolutie & Juridisch (Experts 39-44)
...
### CATEGORIE F: Persoonlijke Kracht & Mindset (Experts 45-50)
...
- [ ] Arjan's huidige situatie verkennen (LinkedIn, website Social Media Hulp)
...
| Als Arjan... | Dan is mijn alternatief... |
|--------------|---------------------------|
| Niet opneemt | Email sturen, later terugbellen |
| Weigert te betalen | Betalingsherinnering sturen → Incasso overwegen |
