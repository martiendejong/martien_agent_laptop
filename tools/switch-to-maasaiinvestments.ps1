...
<#
.SYNOPSIS
    Switch WordPress to Maasai Investments site
.DESCRIPTION
    Changes database to 'maasaiinvestments' and activates maasai-investments-theme
#>
...
$themeName = "maasai-investments-theme"

Write-Host "=== Switching to Maasai Investments ===" -ForegroundColor Cyan
