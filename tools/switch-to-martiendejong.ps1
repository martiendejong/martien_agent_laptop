...
<#
.SYNOPSIS
    Switch WordPress to martiendejong.nl site
.DESCRIPTION
    Changes database to 'martiendejong' and activates martiendejong-wp-theme
#>
...
$themeName = "martiendejong-wp-theme"

Write-Host "=== Switching to martiendejong.nl ===" -ForegroundColor Cyan
