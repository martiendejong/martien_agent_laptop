# Semantic Memory Search v2 - Phase 3
# Simplified implementation using text similarity (Phase 3.1)
# Future: Vector embeddings with sentence-transformers (Phase 3.2)
# Created: 2026-02-07
...
if (-not [string]::IsNullOrWhiteSpace($Query)) {
    ...
    Write-Host ""
    Write-Host "Semantic Memory Search v2 - Usage" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "  semantic-memory-v2.ps1 'your query' [-Source <source>] [-Limit <n>]" -ForegroundColor Gray
    Write-Host ""
    ...
    Write-Host "  semantic-memory-v2.ps1 'worktree mistakes'" -ForegroundColor Gray
    Write-Host "  semantic-memory-v2.ps1 'consciousness optimization' -Source reflection" -ForegroundColor Gray
    Write-Host "  semantic-memory-v2.ps1 'PR dependencies' -Limit 10" -ForegroundColor Gray
    Write-Host ""
}
