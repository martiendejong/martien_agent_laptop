...
if ($History) {
    ...
    if ($unanswered.Count -gt 0) {
        ...
        Write-Host "💡 Answer with: curiosity-engine.ps1 -QuestionId <id> -Answer '...'" -ForegroundColor DarkGray
        Write-Host ""
    }
...
Write-Host "💡 Answer important ones with: curiosity-engine.ps1 -QuestionId <id> -Answer '...'" -ForegroundColor DarkGray
Write-Host ""
