...
|---|---|---|---|---|---|---|---|---|
| agent-001 | agent001 | C:\Projects | C:\Projects\worker-agents\agent-001 | BUSY | client-manager + hazina | fix/facebook-import-400-error | 2026-02-05T02:00:00Z | 🔧 URGENT: Fix Facebook import 400 error (data model mismatch) |
