...
|---|---|---|---|---|---|---|---|---|
| agent-001 | agent001 | C:\Projects | C:\Projects\worker-agents\agent-001 | BUSY | client-manager | agent-001-select-document-extraction | 2026-01-14T02:00:00Z | 🔄 Select from uploaded docs for header/footer extraction |
